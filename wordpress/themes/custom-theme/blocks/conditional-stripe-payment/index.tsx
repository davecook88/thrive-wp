...
registerBlockType<ConditionalStripePaymentAttributes>("custom-theme/conditional-stripe-payment", {
  ...
  edit: ({
    ...
    return (
      <Fragment>
        <div {...blockProps}>
          <ServerSideRender
            block="custom-theme/conditional-stripe-payment"
          ...
          <InspectorControls>
            <PanelBody title="Content Settings" initialOpen={true}>
              ...
              <TextControl
                ...
                onChange={(value) => setAttributes({ selectPackageMessage: value })}
            ...
            <PanelBody title="Button Settings" initialOpen={false}>
              <TextControl
                ...
                onChange={(value) => setAttributes({ confirmButtonText: value })}
              />
              <TextControl
                label="Cancel Button Text"
                value={attributes.cancelButtonText}
                onChange={(value) => setAttributes({ cancelButtonText: value })}
              />
              <TextControl
                label="Loading Text"
              ...
              {attributes.showBackLink && (
                <>
                  <TextControl
                    ...
                    onChange={(value) => setAttributes({ backLinkUrl: value })}
                  />
                  <TextControl
                    label="Back Link Text"
                    value={attributes.backLinkText}
                    onChange={(value) => setAttributes({ backLinkText: value })}
                  />
                </>
              )}
            </PanelBody>
