...
import { PanelBody, TextControl, ColorPalette, RangeControl } from '@wordpress/components';
    ...
    edit: ({ attributes, setAttributes }) => {
        ...
        return (
            <>
                <InspectorControls>
                    <PanelBody title={__('Settings', 'custom-theme')}>
                        ...
                        <div>
                            ...
                            <ColorPalette
                                value={accentColor}
                                onChange={(value) => setAttributes({ accentColor: value || '#9aa8ff' })}
                                colors={[
                        ...
                        <RangeControl
                            ...
                            onChange={(value) => setAttributes({ showPreviewWeeks: value || 2 })}
                            min={1}
                            max={8}
                        />
                    </PanelBody>
                ...
                <div {...blockProps} style={{ border: '1px solid #e1e5e9', borderRadius: '8px', padding: '2rem', textAlign: 'center' }}>
                    <h2 style={{ color: accentColor, marginBottom: '0.5rem' }}>{heading}</h2>
                    ...
                    <div style={{ background: '#f8fafc', padding: '1rem', borderRadius: '4px', marginBottom: '1rem' }}>
                        ...
                        <small style={{ color: '#64748b' }}>
                            Preview: {showPreviewWeeks} week{showPreviewWeeks !== 1 ? 's' : ''}
                        </small>
                    </div>
