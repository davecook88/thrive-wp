...
registerBlockType<BookingSessionDetailsAttributes>(
  "custom-theme/booking-session-details",
  {
    title: "Booking Session Details",
    icon: "calendar-alt",
    category: "widgets",
    description:
      "Display session details with merge fields for booking confirmation.",
    ...
    edit: ({
      ...
      return (
        <Fragment>
          <div {...blockProps}>
            <BookingSessionDetailsComponent attributes={attributes} />
          </div>
            ...
            <InspectorControls>
              <PanelBody title="Display Settings" initialOpen={true}>
                ...
                <ToggleControl
                  ...
                  onChange={(value) =>
                    setAttributes({ showTeacherName: value })
                  }
                />
                <ToggleControl
