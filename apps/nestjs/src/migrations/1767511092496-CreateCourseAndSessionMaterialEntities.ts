  ...
  implements MigrationInterface
{
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    created_by_id int NULL COMMENT 'FK to user.id (admin who created it)',
    ...
    await queryRunner.query(
      "ALTER TABLE student_answer ADD CONSTRAINT FK_c2dee29ba5d778a14ec4675ad28 FOREIGN KEY (student_id) REFERENCES user(id) ON DELETE CASCADE ON UPDATE NO ACTION",
    );
    await queryRunner.query(
